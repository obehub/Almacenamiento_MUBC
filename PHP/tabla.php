...
<head>
    ...
    <link rel="stylesheet" href="/Almacenamiento_MUBC/CSS/tabla.css">
...
<body>
    <header>
        <nav class="nav-container">
            <img src="/Almacenamiento_MUBC/IMAGENES/MUBC.JPG" alt="Logo MUBC" class="logo">
            <label for="text">Movimiento Union y Bienestar Ciudadano</label>
            <ul class="nav-links">
                <li><a href="/Almacenamiento_MUBC/admin.html"><i class="fas fa-home"></i> Inicio</a></li>
                <li><a href="/Almacenamiento_MUBC/PHP/tabla.php"><i class="fas fa-users"></i> Inscritos</a></li>
                <li><a href="/Almacenamiento_MUBC/agregar_admin.html"><i class="fas fa-user-plus"></i> Agregar administrador</a></li>
            </ul>
        </nav>
    </header>
